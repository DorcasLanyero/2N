...
### Goals
The goal of this game is for the user to produce a tile with the highest tile size as defined by the difficulty level (see difficulty level table ab
### User Skills
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk2ODcwNDE5NywtMTUzMDUwMDYwNiwyMj
